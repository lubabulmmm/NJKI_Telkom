<x-app-layout>
    ...
    <div class="ml-0 sm:ml-60 max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="p-4 sm:p-8">
            <div class="flex-1 overflow-y-auto mt-8 p-6 min-h-screen">
                ...
                <div class="p-6">
                    <form id="addItemForm" method="POST" action="{{ route('superadmin.items.store') }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4 flex justify-between">
                            ...
                            <button type="button" onclick="history.back()"
                                class="bg-red-500 text-white px-4 py-2 rounded-lg w-1/2 ml-4 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                                <span class="flex items-center justify-center">
                                    <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div id="confirmationModal"
        ...
        <div
            ...
            <div class="flex items-center mb-4">
                ...
                <h3 class="ml-3 text-lg font-medium text-gray-700">Confirm Addition</h3>
            </div>
            <p class="text-gray-600 mb-6">Are you sure you want to add the item "<span id="itemNameDisplay"
            ...
            <div class="flex justify-between space-x-3">
                ...
                <button id="confirmSubmissionButton"
                    class="flex-1 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transform hover:scale-105 transition-all duration-200">
                    <span class="flex items-center justify-center">
                        <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M5 13l4 4L19 7" />
    ...
    <div id="loadingOverlay"
        ...
        <div class="bg-white p-6 rounded-lg shadow-2xl">
            <div class="flex items-center">
                ...
                <span class="ml-3 text-gray-700 font-medium">Adding item...</span>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // Show the confirmation modal when the "Add Item" button is clicked
