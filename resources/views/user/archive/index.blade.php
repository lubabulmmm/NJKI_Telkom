                ...
                <div class="bg-white/90 mt-8 glassmorphism rounded-3xl card-shadow mb-8">
                    ...
                    <div class="bg-white text-black border-b p-8 rounded-t-3xl">
                        <div class="flex justify-between items-center">
                            <div>
                                <h1 class="text-3xl font-bold mb-2">📁 My Investment Archives</h1>
                                <p class="text-lg opacity-90">History of your saved calculations</p>
                            </div>
                            <a href="{{ route('user.calculator') }}"
                                class="btn-hover text-white bg-amber-500 hover:bg-amber-600 px-6 py-2 rounded-xl font-semibold shadow-lg hover:shadow-xl flex items-center space-x-2">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('user.investment.archive.index', array_merge(request()->query(), ['viability' => 'all'])) }}"
                                    class="filter-badge {{ request('viability', 'all') === 'all' ? 'active' : 'inactive' }}">
                                    All
                                </a>
                                <a href="{{ route('user.investment.archive.index', array_merge(request()->query(), ['viability' => 'layak'])) }}"
                                    class="filter-badge {{ request('viability') === 'layak' ? 'active' : 'inactive' }}">
                                    LAYAK
                                </a>
                                <a href="{{ route('user.investment.archive.index', array_merge(request()->query(), ['viability' => 'tidak-layak'])) }}"
                            ...
                            <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                                ...
                                <form method="GET" action="{{ route('user.investment.archive.index') }}"
                                    class="relative">
                        ...
                        <div class="overflow-x-auto">
                            @if ((request('search') || request('viability')) && $archives->isEmpty())
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-yellow-700">
                                                No archives found matching your search criteria. Try different keywords
                                                or filters.
                                            </p>
                                        </div>
                                    </div>
...
if (
        ...
        $formatted .= $newMonths . ' bulan';
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('user.investment.archive.show', $archive->id) }}"
                                                    ...
                                                    <button type="button"
                                                        onclick="showDeleteModal('{{ route('user.investment.archive.destroy', $archive->id) }}')"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="px-6 py-4 text-center text-sm text-gray-500">
                                                No investment archives found. Create your first calculation to get
                                                started.
                                            </td>
                                        </tr>
                                    @endforelse
    ...
    <div id="delete-error-notification" class="fixed top-4 right-4 z-50 hidden">
        <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-lg w-full max-w-sm">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                ...
                <div class="ml-3">
                    <h3 id="delete-error-title" class="text-sm font-medium text-red-800">Error</h3>
                    <p id="delete-error-message" class="text-sm text-red-600 mt-1">Failed to delete archive</p>
                </div>
                <button type="button" onclick="hideDeleteError()"
